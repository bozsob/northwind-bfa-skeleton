 ...
 */
@WebServlet("/customersAndSuppliers")
public class CustomersAndSuppliersServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            objectMapper.writeValue(response.getOutputStream(), dao.getCustomersAndSuppliers());
        }
        catch (Exception e) {
            e.printStackTrace();
        }
